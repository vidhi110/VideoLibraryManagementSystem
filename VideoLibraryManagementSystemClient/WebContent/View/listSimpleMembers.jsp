...
<title>List Simple Members</title>
...
<%
	...
	SimpleMembers[] listPerson	= (SimpleMembers[])sess.getAttribute("listsimple");
 %>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatmeo_content" >
        ...
        <div class="content_section">
			...
			<H2 ALIGN="CENTER">List of Simple Members</H2>
...
<!-- 					<TH>Rent Amount</TH>
 -->					<TH>Outstanding Movies</TH>
				...
				<form name='deletePerson' action='delete' method='post'>
					<input type='hidden' name='memberId' value=<%=listPerson[i].getMembershipId()%>>
					<input type='hidden' name='formname' value='deletePerson'>
					<TR>
						<TD><%=(i+1) %></TD>
						<TD><%=listPerson[i].getMembershipId() %></TD>
						<TD><a href="personInfoAdmin?memberId=<%=listPerson[i].getMembershipId()%>"><%=listPerson[i].getFirstName() %>
								&nbsp;&nbsp;<%=listPerson[i].getLastName()%></a></TD>
		
						<%-- 		<TD><%=listPerson[i].getFirstName() %> &nbsp;&nbsp;<%=listPerson[i].getLastName()%> </TD>
					 --%>
						<TD><%=listPerson[i].getEmailId()%>
<%-- 						<TD><%=listPerson[i].getRentForMoviesIssued()%>
 --%>						<TD><%=listPerson[i].getTotalOutstandingMovies()%>
