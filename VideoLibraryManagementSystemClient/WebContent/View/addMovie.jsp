        ...
        <div class="content_section">
        	...
        	<div style="height:500px;border:1px solid #ccc;width:800px;font:16px/26px Georgia, Garamond, Serif;overflow:auto;">
         	...
         	<center>
   			...
   			<h2>Add Movie</h2>
   			<h5>All fields are compulsary</h5>
     
     
                       	 <table align="center">
     
                 <form name="addMovie" method="post" action="addMovie" onsubmit="return checkMovie()">
                  
                        
                    <tr><td>      
                    <label ><strong>Movie Name:</strong></label></td><td>
                    <input type="text" class="contact_input" name="movieName" required/></td></tr>
                    
                    <tr><td> 
                    <label ><strong>Release Date:</strong></label></td><td>
                    <input type="date" class="contact_input" name="releaseDate" required/></td><td><!-- e.g 2012-12-12 --></td></tr>
                    ...
                    <input type="text" class="contact_input" name="banner" required/></td></tr>
                    
                    <tr><td>
                    <label class="contact"><strong>Available Copies:</strong></label></td><td>
                    <input type="text" class="contact_input" name="copies" required/></td></tr>
                    <tr><td>
                    <label class="contact"><strong>Rent Amount:</strong></label></td><td>
                    <input type="text" class="contact_input" name="rent" required/></td></tr>
