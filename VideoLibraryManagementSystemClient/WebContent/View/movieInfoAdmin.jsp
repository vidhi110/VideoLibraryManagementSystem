...
<%
	...
	Movie movieInfo	= (Movie)sess.getAttribute("movieInfo");
	
	 Person[] person = movieInfo.getUsers();
...
<% 
	Calendar TimeStop = movieInfo.getMovieReleaseDate();
    ...
    <div id="templatmeo_content" >
        ...
        <div class="content_section">
        	...
        	<div style="height:500px;border:1px solid #ccc;width:800px;font:16px/26px Georgia, Garamond, Serif;overflow:auto;">
				...
				<tr><td>Name:</td><td><%=movieInfo.getMovieName() %></td></tr>
				<tr><td>Banner:</td><td><%=movieInfo.getMovieBanner() %></td></tr>
				<tr><td>Category:</td><td><%=movieInfo.getMovieCategory() %></td></tr>
				<tr><td>Release Date:</td><td><%=TimeStop_Str %></td></tr>
				</table>
				<h2 align="center"> Issued by Member</h2>
				...
				for(int i=0; i < person.length; i++) { %>
					...
					<tr><td><%=person[i].getFirstName() %><%=person[i].getLastName() %></td></tr>
