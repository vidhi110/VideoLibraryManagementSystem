...
<title>List Premium Members</title>
...
PremiumMembers[] listPerson	= (PremiumMembers[])sess.getAttribute("listpremium");
 %>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatmeo_content" >
        ...
        <div class="content_section">
			...
			<H2 ALIGN="CENTER">List of Premium Members</H2>
			...
			for(int i=0;i<listPerson.length;i++){ %>
				...
				<form name='deletePerson' action='delete' method='post'>
					...
					<TR>
						...
						<%-- 		<TD><%=listPerson[i].getFirstName() %> &nbsp;&nbsp;<%=listPerson[i].getFirstName()%> </TD>
			 --%>
						<TD><%=listPerson[i].getEmailId()%>
						<TD><%=listPerson[i].getDueAmount()%>
