...
<%
	...
	//Person userType1	= (Person)sess.getAttribute("userType");
 ...
 <%String parameter =request.getParameter("issue");
...
function invalidlogin()
{
    ...
    alert("You can rent only 2 movies.");
         }
     if (p1=="Premium")
     {
alert("You can rent only 10 movies.");
     }
}
    ...
    <div id="templatmeo_content" >
        ...
        <div class="content_section">
			...
			<div style="height:500px;border:1px solid #ccc;width:800px;font:16px/26px Georgia, Garamond, Serif;overflow:auto;">
				...
				<%
					if (listMovies == null) {
						out.println("<h3 align='center'>No items in Cart</h3>");
					} else {
				%>

				<TABLE style="font-family: cursive;" border="1" align="center">
					<TR>
						<TH>Number
						<TH>Movie Name</TH>
						<TH>Rent($)</TH>
					...
					<form name='remove' action='cart' method='post'>
						<input type='hidden' name='formname' value='remove'> <input
							type='hidden' value=<%=listMovies[i].getCartId()%> name='cartId'>
						<TR>
				...
				<form name='checkout' method='post' action='cart'>
