...
<%
	...
	Person personInfo	= (Person)sess.getAttribute("personInfo");
	
	
	 Transactions[] movie = personInfo.getTransactions();
		

	 System.out.println("fdsfd" + movie[0].getMovie().getMovieName());
    ...
    <div id="templatmeo_content" >
        ...
        <div class="content_section">
			...
			<table align='center' style="font-family: cursive;" border="1">
						<tr><td>Membership Id:</td><td><%=personInfo.getMembershipId()%></td></tr>
			
			<tr><td>Name:</td><td><%=personInfo.getFirstName() %>&nbsp;<%=personInfo.getLastName() %></td></tr>
			<tr><td>Email:</td><td><%=personInfo.getEmailId() %></td></tr>
			<tr><td>City:</td><td><%=personInfo.getCity() %></td></tr>
			</table>
			<h2 align="center"> Movies Issued by Member</h2>
				...
				for(int i=0; i < movie.length; i++) { %>
					...
					<tr><td><%=movie[i].getMovie().getMovieName()%></td></tr>					
...
<%-- 			<table align='center' style="font-family: cursive;margin-left: 20px" border="1">
 ...
 --%>			
			...
			<a href="listAllMembers.jsp">Back</a>
