...
<div id="templatemo_wrapper">
    ...
    <div id="templatmeo_content" >
        ...
        <div class="content_section">
				...
				<ol>
					<li>Movies are only available for rent.</li>
					</br>

					<li>Movies issued should be return in 14 days.</li>
					</br>
					<li>Failure of returning the movie on or before the due date
						will be charged.</li>
					</br>
					<li>Issued movie should be returned in the same condition.</li>
					</br>
